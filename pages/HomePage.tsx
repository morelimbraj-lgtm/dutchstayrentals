            ...
            <div className="w-full">
                ...
                <div className="relative" ref={locationDropdownRef}>
                    <button 
                      ...
                      className={`w-full text-left bg-black/40 border ${isLocationDropdownOpen ? 'border-indigo-500 ring-1 ring-indigo-500' : 'border-white/20'} hover:bg-black/50 rounded-xl shadow-lg text-white px-4 py-3.5 flex items-center justify-between transition-all duration-200 group`}
                    >
                    ...
                    {isLocationDropdownOpen && (
                        <div className="absolute z-50 mt-2 w-full bg-[#1a1a1a]/95 backdrop-blur-2xl border border-white/10 rounded-xl shadow-2xl max-h-80 overflow-auto focus:outline-none animate-in fade-in zoom-in-95 duration-200">
                            <div className="py-1">
                                <div 
            ...
            <div className="w-full">
                ...
                <div className="relative" ref={sortDropdownRef}>
                    <button 
                      ...
                      className={`w-full text-left bg-black/40 border ${isSortDropdownOpen ? 'border-indigo-500 ring-1 ring-indigo-500' : 'border-white/20'} hover:bg-black/50 rounded-xl shadow-lg text-white px-4 py-3.5 flex items-center justify-between transition-all duration-200 group`}
                    >
                    ...
                    {isSortDropdownOpen && (
                        <div className="absolute z-50 mt-2 w-full bg-[#1a1a1a]/95 backdrop-blur-2xl border border-white/10 rounded-xl shadow-2xl overflow-auto focus:outline-none animate-in fade-in zoom-in-95 duration-200">
                            <div className="py-1">
